...
<body>
                            ...
                            <div id="tableContainer">
                                <table class="datatables-customers table border-top" id="mainTable">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="8">Commencez à gérer votre menu en créant des catégories
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="mb-3" id ="exampleForm2" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label class="form-label ms-3" for="nom">Nom</label>
                            <input type="text" class="form-control" value="" id="Nom"
                                name="Nom">
                        </div>
    ...
    <script>
        const tableRows = document.querySelectorAll('.clickable-row3');

        tableRows.forEach(row => {
            row.addEventListener('click', function() {
                const modalTitle3 = document.getElementById('exampleModalLabel3');
                const nomInput3 = document.getElementById('Nom3');
                const refInput3 = document.getElementById('Référence3');

                modalTitle3.textContent = 'Modifier la catégorie: ' + this.dataset.nom;
                nomInput3.setAttribute('value', this.dataset.nom);
                refInput3.setAttribute('value', this.dataset.reference);
            });
        });
    </script>
